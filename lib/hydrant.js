...
module.exports = class Hydrant {
  ...
  /**
   * Add additional resources to Hydrant
  ...
  /**
   * Return an array of resources currently active in Hydrant.
   * @return {array}
   *   The resources currently active in Hydrant.
   */
  getResources(){
  ...
  /**
   * Remove one or more resources from Hydrant.
